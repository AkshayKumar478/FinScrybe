...
export function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("http://localhost:5000/api/auth/company-admin/login", {
        method: "POST",
      ...
      setClientUser({ 
        ...
        role: data.user.companyAdminRole,
        actorType: data.user.actorType
      });
        ...
        <div className="max-w-md w-full my-auto">
          ...
          <form className="space-y-5" onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex justify-center items-center gap-2 bg-[#635BFF] hover:bg-[#5448F7] text-white font-bold py-3.5 px-4 rounded-xl shadow-[0_4px_12px_rgba(99,91,255,0.25)] hover:shadow-[0_6px_16px_rgba(99,91,255,0.35)] transition-all text-sm disabled:opacity-70"
            >
