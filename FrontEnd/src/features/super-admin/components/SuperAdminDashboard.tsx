...
export function SuperAdminDashboard() {
  ...
  const activeTab = useDashboardStore((state) => state.superAdminActiveTab);
  const setActiveTab = useDashboardStore((state) => state.setSuperAdminActiveTab);
        ...
        <header className="bg-white border-b border-slate-200 px-8 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <h2 className="text-sm font-extrabold text-slate-900 leading-tight">Alex Chen</h2>
                <span className="text-[10px] font-bold text-[#635BFF] uppercase tracking-wider block mt-0.5">Admin</span>
              </div>
            </div>
          </div>
        </header>

        {/* Content body with welcome placeholder */}
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="bg-white border border-slate-200 rounded-3xl p-12 shadow-sm text-center max-w-md w-full">
            ...
            <p className="text-slate-500 font-semibold text-sm">
              This is a placeholder page for the Super Admin {tabLabels[activeTab] || activeTab} view.
            </p>
          </div>
        </div>
      </main>
