...
export function ClientDashboard() {
  ...
  const activeTab = useDashboardStore((state) => state.clientActiveTab);
  const setActiveTab = useDashboardStore((state) => state.setClientActiveTab);
  ...
  return (
    <div className="min-h-screen flex bg-[#f8fafc] font-sans antialiased text-[#111827]">
      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        {/* Content body with simple welcome page */}
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="bg-white border border-slate-200 rounded-3xl p-12 shadow-sm text-center max-w-md w-full">
            ...
            <p className="text-slate-500 font-semibold text-sm">
              This is a placeholder page for the {tabLabels[activeTab] || activeTab} view.
            </p>
          </div>
        </div>
      </main>
